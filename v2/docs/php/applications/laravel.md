...
```bash
clpctl site:add:php --domainName=www.domain.com --phpVersion=8.1 --vhostTemplate='Laravel 9' --siteUser='john-doe' --siteUserPassword='!secretPassword!'
```
...
```bash
php8.1 /usr/local/bin/composer create-project --prefer-dist laravel/laravel:^9 -n www.domain.com
```

4. Done! You can now open your **site** in your browser to see the **welcome page**.

<img class="border" alt="Laravel Installed" src={useBaseUrl('img/php/applications/laravel/laravel-installed.png')} />