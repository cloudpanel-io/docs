...
<img class="border" alt="Create a Slim Site" src={useBaseUrl('img/php/applications/slim/create-site-form.png?v=0.0.3')} />
...
```bash
clpctl site:add:php --domainName=www.domain.com --phpVersion=8.5 --vhostTemplate='Slim 4' --siteUser='john-doe' --siteUserPassword='!secretPassword!'
```
...
```bash
php8.5 /usr/local/bin/composer create-project slim/slim-skeleton:~4 www.domain.com
```
